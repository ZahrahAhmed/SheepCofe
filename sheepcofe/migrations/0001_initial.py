# Generated by Django 2.0 on 2017-12-06 16:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bean', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sheepcofe.Bean')),
            ],
        ),
        migrations.CreateModel(
            name='Powder',
        ...
        migrations.AddField(
            model_name='coffee',
            name='powders',
            field=models.ManyToManyField(blank=True, to='sheepcofe.Powder'),
        ),
        migrations.AddField(
            model_name='coffee',
            name='roast',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sheepcofe.Roast'),
        ),
        migrations.AddField(
            model_name='coffee',
            name='syrups',
            field=models.ManyToManyField(blank=True, to='sheepcofe.Syrup'),
        ),
        migrations.AddField(
            model_name='coffee',
            name='user',
